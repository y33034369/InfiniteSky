...
cli.makecsv = function CLI_MakeCSV(input) {
  infoToCSV('Item', [
    'ID','Name','Rareness','ItemType','LevelRequirement',
    'HonorPointReq','SkillBonusID1','SkillBonusID2',
    'SkillBonusID3','SkillBonusAmount1','SkillBonusAmount2',
    'SkillBonusAmount3','Description2','Description3'
  ], console.log);

  infoToCSV('Monster', [
    'ID','Name','Health','AttackPower','DefensePower','Critical'
  ], console.log);
  ...
  infoToCSV('Exp', [
    'Level','EXPStart','EXPEnd','SkillPoint'
  ], console.log);

  infoToCSV('Skill', [
    'ID','Name','Clan','Weapon','PointsToLearn','MaxSkillLevel',
